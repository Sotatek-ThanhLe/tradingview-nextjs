        ...
        (t = (function (e) {
          ...
          return (
              ...
              return e.isOpened
                ? (u.OverlapManager.registerWindow(this._uuid),
                  s.createElement(
                    ...
                    r.__assign({}, e, {
                      key: this._uuid,
                      zIndex: u.OverlapManager.getZindex(this._uuid),
                    }),
                    e.children,
                  ))
            ...
            (t.prototype._subscribe = function () {
              u.OverlapManager.getStream().on(
                this._zIndexUpdateEvent,
                this._onZIndexUpdate,
              );
            }),
            (t.prototype._unsubscribe = function () {
              u.OverlapManager.getStream().off(
                this._zIndexUpdateEvent,
                this._onZIndexUpdate,
              );
            }),
      ...
      return (
        ...
        i.createElement(
          s.CSSTransitionGroup,
          {
            ...
            transitionEnterTimeout: u.dur,
            transitionLeaveTimeout: u.dur,
          },
          t
            ? i.createElement(
                'div',
    ...
    (function (e, o) {
          ...
          null != e &&
            ...
            u < i.length &&
              ...
              quoteSessionMultiplexerInstance.full.subscribe(
                ...
                function (t, n) {
                  l(n.values, i),
                    quoteSessionMultiplexerInstance.full.unsubscribe(c, e),
                    r(d);
                },
              )),
            (d = {
      ...
      function r(e) {
        E ||
          ...
          C.render(M.createElement(L, e), E);
      }
      function s(e) {
        var t,
          n = D;
        ...
        for (n = 0; n < t.length; n++)
          (o = t[n].propName) in e &&
            ...
            'minmove2' === o && e.minmove2 > 0 && !e.fractional && e.pricescale
              ? ((t[n].value = new w(e.pricescale / i).format(
                  i / e.pricescale,
                )),
