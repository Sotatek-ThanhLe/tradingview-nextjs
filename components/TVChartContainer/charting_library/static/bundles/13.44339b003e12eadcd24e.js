    ...
    function o(t) {
      return l.__awaiter(this, void 0, void 0, function () {
        return l.__generator(this, function (e) {
          return [
            2,
            r(f.labelRename, f.error, f.titleCopy, f.valueCopy.format(t)),
          ];
        });
      });
    }
        ...
        return (
                ...
                return l.__generator(this, function (r) {
                  switch (r.label) {
                    ...
                    case 1:
                      return (
                        (e = r.sent()),
                        e ? [4, o(t.metaInfo.name.value())] : [3, 3]
                      );
                    case 2:
                      return (
                        (n = r.sent()),
                        this._saveCurrentChartAsNewWithTitle(n),
                        [3, 3]
                      );
                    case 3:
                      return [2];
                  ...
                  switch (r.label) {
                    case 0:
                      return (
                        ...
                        (e = t.metaInfo.name.value()),
                        [4, a(e)]
                      );
                    case 1:
                      return (
                        (n = r.sent()),
                        t.metaInfo.name.setValue(n),
                        this._doSave(),
                        [2]
                      );
                  }
          ...
          (t.prototype._saveCurrentChartAsNewWithTitle = function (t) {
            ...
            v.enabled('saveload_storage_customization')
              ? (e.metaInfo.uid.deleteValue(),
                e.metaInfo.id.deleteValue(),
                e.metaInfo.name.setValue(t),
                this._doSave())
              : window.open(
                  '/chart/?clone=' +
                    e.metaInfo.uid.value() +
                    '&name=' +
          ...
          (t.prototype._doSave = function () {
            ...
            this._chartSaver.saveChartSilently(function () {
              d.trackEvent('GUI', 'Save Chart Layout'),
                u(t.metaInfo.uid.value());
            });
          }),
          t
        );
