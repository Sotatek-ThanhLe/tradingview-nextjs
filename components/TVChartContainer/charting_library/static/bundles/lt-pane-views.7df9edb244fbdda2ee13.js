webpackJsonp([1], {
          ...
          for (
            ...
            (u = 'level' + _),
              ...
              f.visible.value() &&
                ...
                (y = a.add(o).scaled(0.5).normalized().scaled(w)),
                (m = t.add(y)),
                this._levels.push({
                  coeff: g,
                  color: v,
      ...
      (n.prototype.renderer = function () {
        ...
        for (
          ...
          if (
            ...
            if (
              !(x =
                this._cacheState.preparedCells.cells[this._levels[v].index - 1])
            )
              continue;
            (b = {
              left: x.left,
    ...
    inherit(n, a),
      ...
      (n.prototype._updateImpl = function () {
        ...
        if (
          ...
          (this._cacheState =
            this._model._fibRetracementLabelsCache.updateSource(this._source)),
      ...
      (n.prototype.renderer = function () {
        ...
        for (
          ...
          if (
            ...
            if (
              !(S =
                this._cacheState.preparedCells.cells[this._levels[w].index - 1])
            )
              continue;
    ...
    (n.prototype.draw = function (e) {
      ...
      (r.prototype._updateImpl = function () {
        ...
        if (
          ...
          (this._cacheState =
            this._model._fibSpeedResistanceArcsLabelsCache.updateSource(
              this._source,
            )),
          !(this._floatPoints.length < 2) &&
            this._source.priceScale() &&
      ...
      (r.prototype.renderer = function () {
        ...
        for (
          ...
          if (
            ...
            if (
              !(g =
                this._cacheState.preparedCells.cells[this._levels[l].index - 1])
            )
              continue;
            (v = {
              left: g.left,
    ...
    inherit(n, s),
      ...
      (n.prototype._updateImpl = function () {
        ...
        if (
          (s.prototype._updateImpl.call(this),
          (this._cacheState =
            this._model._trendBasedFibExtensionLabelsCache.updateSource(
              this._source,
            )),
          !(this._source.points().length < 3) &&
            this._source.priceScale() &&
      ...
      (n.prototype.renderer = function () {
        ...
        for (
          ...
          if (
            ...
            if (
              !(R =
                this._cacheState.preparedCells.cells[this._levels[m].index - 1])
            )
              continue;
      ...
      (n.prototype.renderer = function () {
        ...
        for (
          ...
          if (
            ...
            if (
              !(f =
                this._cacheState.preparedCells.cells[this._levels[a].index - 1])
            )
              continue;
            (g = {
              left: f.left,
      ...
      (n.prototype.renderer = function () {
        ...
        if (
          ...
          if (
            ...
            for (
              a = new c(),
                l = n === _.Bars ? ['high', 'low'] : ['open', 'close'],
                f = l[0],
                g = l[1],
                v = 0;
            ...
            return (
              this.isAnchorsRequired() &&
                a.append(this.createLineAnchor({ points: this._points })),
              a
            );
          }
          return (
          ...
          2 === this._source.points().length
            ? ((e = this._source.priceScale()),
              ...
              (l = function (r) {
                var o = (r - t) * i + t;
                return (
                  e.isPercent() && (o = s.convertToPercent(o, n)),
          ...
          for (o = 1; o <= 11; o++)
            (l = 'level' + o),
              ...
              h.visible.value() &&
                ...
                r.showCoeffs.value() &&
                  ((u.text = d), (u.y = this._source.priceScale().height())),
                this._levels.push(u));
      }),
      (n.prototype.renderer = function () {
        ...
        for (
          ...
          if (
            ...
            switch (
              ((P = n.horzLabelsAlign.value()),
              (P = 'left' === P ? 'right' : 'right' === P ? 'left' : 'center'))
            ) {
              case 'left':
                b = 3;
                break;
            ...
            switch (n.vertLabelsAlign.value()) {
              case 'top':
                ...
                break;
              case 'middle':
                (x = new r(this._levels[v].x, 0.5 * this._levels[v].y)),
                  (S = 0);
                break;
              case 'bottom':
          ...
          if (
            ...
            switch (n.vertLabelsAlign.value()) {
              case 'top':
                ...
                break;
              case 'middle':
                (y = new r(this._levels[s].x, 0.5 * this._levels[s].y)),
                  (x = 0);
                break;
              case 'bottom':
        ...
        return (
          ...
          this._points.length < 2 || this._source.points().length < 2
            ...
            : ((t = this._source.properties()),
              ...
              (P =
                this._source.priceScale().formatter().format(x) +
                ' (' +
        ...
        return (
          ...
          this._points.length < 2 || this._source.points().length < 2
            ...
            : ((t = this._source.properties()),
              ...
              (C =
                this._source.priceScale().formatter().format(w) +
                ' (' +
        ...
        a.prototype._updateImpl.call(this),
          ...
          this._source.points().length < 2 ||
            ...
            this._source.properties().showPriceRange.value() &&
              ...
              (p = d / e.price),
              (l =
                this._source.priceScale().formatter().format(d) +
                ' (' +
                new c().format(100 * p) +
                ')'),
            ...
            (e.index < i.firstBar() &&
              ...
              this._points.length < 2 ||
                ...
                l || r || a || o || h
                  ? ((d = this),
                    (this._statCache =
                      this._model._trendLineStatsCache.updateSource(
                        this._source,
                        function () {
        ...
        return (
          this._labelDataInvalidated &&
            ...
            _ &&
              ...
              (u = h / t.price),
              (a =
                this._source.priceScale().formatter().format(h) +
                ' (' +
        ...
        return (
          ...
          this._invalidated
            ...
            ? ((t = {}),
              ...
              r &&
                this._middlePoint &&
                e.append(new _({ points: [this._middlePoint] })),
              this.addAnchors(e),
              !TradingView.printing &&
                this._source.hasAlert.value() &&
                !this._model.readOnly() &&
          ...
          if (((this._hfans = []), (this._vfans = []), i.fans.visible.value()))
            for (l = 1; l <= 7; l++)
              (v = Math.round(g + i['hlevel' + l].coeff.value() * f)),
                ...
                this._vfans.push(
                  this._source.priceScale().priceToCoordinate(_),
                );
        }
      }),
    ...
    inherit(n, r),
      ...
      (n.prototype.renderer = function () {
        ...
        return (
          ...
          this._renderer.setData(e),
          this.isAnchorsRequired()
            ? ((t = new s()), t.append(this._renderer), this.addAnchors(t), t)
            : this._renderer
        );
      }),
                ...
                (0 !== this._model.mainSeries().bars().length &&
                  ...
                  (i = this._source.lastBarData()) &&
                    ...
                    n.isPercent() &&
                      ...
                      (i.closePrice = n
                        .priceRange()
                        .convertToPercent(i.closePrice, o))),
        ...
        return (
          ...
          this._points.length < 2 || this._source.points().length < 2
            ...
            : ((t = this),
              ...
              this._points[1] &&
                void 0 !== this._pl &&
                (A = this._source.priceScale().formatter().format(this._pl)),
              i.compact.value()
                ? ((M += A ? A + ' ~ ' : ''),
                  (M += i.qty.value() + '\n'),
                  (M += D))
              ...
              this._pl < 0
                ...
                : this._pl > 0 && (O = i.profitBackground.value()),
              ...
              (M = ''),
              (V = this._source.priceScale().formatter().format(T)),
              (z = this._percentageFormatter.format(L)),
              (M = i.compact.value()
                ? V + ' (' + z + ') ' + i.amountStop.value()
                : this.i18nCache.stop.format(
                    this._source.priceScale().formatter().format(T),
    ...
    inherit(n, r),
      ...
      (n.prototype.renderer = function () {
        ...
        return (
          ...
          this._renderer.setData(e),
          this.isAnchorsRequired()
            ? ((t = new a()), t.append(this._renderer), this.addAnchors(t), t)
            : this._renderer
        );
      }),
      ...
      (n.prototype.drawStartLabel = function (e) {
        ...
        e.save(),
          ...
          e.fillText(
            ...
            a.x + l,
            a.y + this._sourceFontSize1 + 2 * h + this._sourceFontSize2,
          ),
          e.restore();
      }),
      (n.prototype.draw = function (e) {
              ...
              a &&
                ...
                l ||
                  (this._targetLine4 =
                    this._targetLine4 +
                    '  ' +
                    new v(c ? '%h:%m:%s' : '%h:%m').format(a)),
                (p = (a.valueOf() - s.valueOf()) / 1e3),
                (this._targetLine2 =
                  $.t('in', { context: 'dates' }) + ' ' + new w().format(p))),
  ...
  1173: function (e, t, i) {
    ...
    (n.prototype.setData = function (e) {
      ...
      (r.prototype.updateImpl = function () {
        var e, t, i;
        if (
          (o.prototype._updateImpl.call(this), this._source.points().length > 0)
        ) {
          if (
      ...
      (r.prototype.drawTooltipOn = function (e) {
        ...
        for (
          e.save(),
            ...
            c ||
              'top' !== p ||
              (e.lineTo(u - 7, d), e.lineTo(u, d - 7), e.lineTo(u + 7, d)),
            e.lineTo(l + a, d),
            e.lineTo(l + a, d + o),
            c ||
              'bottom' !== p ||
        ...
        for (t.font = this.fontStyle(), s = [], a = 0; a < r.length; a++)
          if (((o = r[a]), (l = t.measureText(o).width) <= n)) s.push(o);
            ...
            for (h = o.split(/([-\)\]\},.!?:;])|(\s+)/); h.length; ) {
              ...
              if (d > 0)
                s.push(h.slice(0, 3 * d - 1).join('')), h.splice(0, 3 * d);
              else {
                if (
                  ((c = h[0] + (h[1] || '')),
        ...
        return (
          ...
          this._source.properties().showLabel.value() &&
            ...
            'right' === r
              ...
              : 'center' === r &&
                (s.x = (s.x + this._model.timeScale().width()) / 2),
            'middle' === n
  ...
  1219: function (e, t, i) {
    ...
    function n(e, t, i, n) {
      return null !== e
        ? o.intersectPolygonAndHalfplane(
            e,
            s.halfplaneThroughPoint(s.lineThroughPoints(t, i), n),
          )
        : null;
    }
    var r, s, a, o, l, h, d, c, p;
        ...
        return (
          ...
          (e.prototype._drawBackground = function (e, t) {
            ...
            if (
              ...
              for (
                e.beginPath(), e.moveTo(o[0].x, o[0].y), l = 1;
                l < o.length;
                l++
              )
          ...
          (e.prototype.draw = function (e) {
            if (
              ...
              if (
                ...
                t.addColorStop(
                  0,
                  r.generateColor(this._data.color1, this._data.transparency),
                ),
                  t.addColorStop(
                    1,
                    r.generateColor(this._data.color2, this._data.transparency),
                  ),
                  (e.fillStyle = t);
              } else
                  ...
                  null !== o
                    ? (this._disjointAngleIntersectionRenderer.setData(e),
                      (this._selectedRenderer =
                        this._disjointAngleIntersectionRenderer))
    ...
    function s(e, t, i, n, r) {
      ...
      for (s = 3 / u, a = 500, o = [], l = 1; l <= a * s; l += s)
        (h = e.scaled((1 - l) * (1 - l))),
          ...
          (p = h.add(d).add(c)),
          o.length > 0 &&
            ((_ = o[o.length - 1]), _.subtract(p).length() < 2 && (s *= 2)),
          o.push(p);
      return o;
    }
    Object.defineProperty(t, '__esModule', { value: !0 }),
