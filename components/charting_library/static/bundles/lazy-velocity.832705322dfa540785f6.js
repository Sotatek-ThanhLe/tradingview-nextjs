    ...
    !(function (e) {
        ...
        (r = function (e, t) {
          ...
          (r.queue = function (e, n, a) {
            ...
            if (e) {
              ...
              var o = r.data(e, n);
              return a
                ? (!o || r.isArray(a) ? (o = r.data(e, n, i(a))) : o.push(a), o)
                : o || [];
            }
          }),
      ...
      (function (i) {
        ...
        return (function (e, t, r, n) {
          ...
          function i(e) {
            return (
              A.isWrapped(e) ? (e = T.call(e)) : A.isNode(e) && (e = [e]), e
            );
          }
          function o(e) {
          ...
          function p(e, t) {
            ...
            return (
              ...
              !1 === r &&
                (r = y.Easings[y.defaults.easing] ? y.defaults.easing : h),
              r
            );
          }
          function d(e) {
                  ...
                  for (
                    ...
                    if (((T = l[S]), (C = T.element), o(C))) {
                        ...
                        if (T.hasOwnProperty(N) && 'element' !== N) {
                          if (
                            ...
                            A.isString(H.pattern)
                              ...
                              : 1 === x
                              ? (O = H.endValue)
                              : ((L = H.endValue - H.startValue),
                                (O = H.startValue + L * j(x, u, L))),
                            !p && O === H.currentValue)
                          )
                            continue;
                          (H.currentValue = O),
                            'tween' === N
                              ...
                              : (v.Hooks.registered[N] &&
                                  ((z = v.Hooks.getRoot(N)),
                                  (R = o(C).rootPropertyValueCache[z]) &&
                                    (H.rootPropertyValue = R)),
                      ...
                      u.mobileHA &&
                        ...
                        ((o(C).transformCache.translate3d = '(0px, 0px, 0px)'),
                        (F = !0)),
          ...
          function f(e, t) {
            ...
            for (
              ...
              if (
                ...
                t ||
                  i.loop ||
                  ('none' === i.display &&
                    v.setPropertyValue(p, 'display', i.display),
                  'hidden' === i.visibility &&
                    v.setPropertyValue(p, 'visibility', i.visibility)),
                (d = o(p)),
                !0 === i.loop ||
                  (g.queue(p)[1] !== n &&
                    /\.velocityQueueEntryFlag/i.test(g.queue(p)[1])) ||
                  (d &&
                    ((d.isAnimating = !1),
                    ...
                    i.mobileHA &&
                      ((f = !0), delete d.transformCache.translate3d),
            ...
            for (
              y.State.calls[e] = !1, m = 0, h = y.State.calls.length;
              m < h;
              m++
            )
              ...
              try {
                ...
                return function (t, r) {
                  ...
                  if (
                    ...
                    if (((a = Array(s)), this.charAt))
                      for (n = 0; n < s; n++) a[n] = this.charAt(i + n);
              ...
              (v = y.CSS =
                {
                    ...
                    register: function () {
                      function e(e, t, r) {
                        ...
                        if (
                          ('border-box' ===
                            (
                              '' + v.getPropertyValue(t, 'boxSizing')
                            ).toLowerCase()) ===
                          (r || !1)
                        ) {
                          for (
                            ...
                            (a = parseFloat(v.getPropertyValue(t, s[n]))),
                              isNaN(a) || (i += a);
                          return r ? -i : i;
                        }
                        return 0;
                          ...
                          v.Normalizations.registered[e] = function (t, r, a) {
                            switch (t) {
                              ...
                              case 'inject':
                                ...
                                return (
                                  i || (o(r).transformCache[e] = '(' + a + ')'),
                                  o(r).transformCache[e]
                                );
                            }
                          };
                        })();
                      ...
                      (v.Normalizations.registered.innerWidth = t('width', !0)),
                        (v.Normalizations.registered.innerHeight = t(
                          'height',
                          !0,
                        )),
                    ...
                    function s(e, r) {
                      ...
                      if (P <= 8) f = g.css(e, r);
                        ...
                        if (
                          ...
                          if (
                            ...
                            'border-box' !==
                              (
                                '' + v.getPropertyValue(e, 'boxSizing')
                              ).toLowerCase()
                          )
                            return (
                              (u =
                      ...
                      return (
                        'auto' === f &&
                          ...
                          ('fixed' === (d = s(e, 'position')) ||
                            ('absolute' === d && /top|left/i.test(r))) &&
                          (f = g(e).position()[r] + 'px'),
                        f
                      );
                    }
                      ...
                      (v.Hooks.registered[r]
                        ? ((u = r),
                          ...
                          v.Normalizations.registered[c] &&
                            (a = v.Normalizations.registered[c](
                              'extract',
                              e,
                              a,
                            )),
                        ...
                        : v.Normalizations.registered[r] &&
                          ...
                          'transform' !== p &&
                            ...
                            v.Values.isCSSNullValue(d) &&
                              v.Hooks.templates[r] &&
                              (d = v.Hooks.templates[r][1])),
                          (l = v.Normalizations.registered[r](
                            'extract',
                            e,
                            d,
                          ))),
                  ...
                  setPropertyValue: function (e, r, n, a, i) {
                    ...
                    if ('scroll' === r)
                      ...
                      v.Normalizations.registered[r] &&
                      'transform' === v.Normalizations.registered[r]('name', e)
                    )
                      v.Normalizations.registered[r]('inject', e, n),
                        (c = 'transform'),
                        (n = o(e).transformCache[r]);
                    else {
                      if (
                        (v.Hooks.registered[r] &&
                          ((s = r),
                        ...
                        (u = o(e)),
                          u && u.isSVG && v.Names.SVGAttribute(r)
                            ? e.setAttribute(r, n)
                            : (e.style[c] = n);
                      y.debug >= 2 &&
              ...
              (y.hook = function (e, t, r) {
                ...
                return (
                  ...
                  g.each(e, function (e, i) {
                    if ((o(i) === n && y.init(i), r === n))
                      a === n && (a = v.getPropertyValue(i, t));
                    else {
                      var s = v.setPropertyValue(i, t, r);
                      'transform' === s[0] && y.CSS.flushTransformCache(i),
                        (a = s);
                    }
                  }),
                  a
              ...
              (x = function () {
                ...
                function a(e, a) {
                        ...
                        (j = function (a, i) {
                          ...
                          if (
                            ...
                            c._cacheValues && u && u[a]
                              ? (G === n && (G = u[a].endValue + u[a].unitType),
                                (W = l.rootPropertyValueCache[B]))
                              : v.Hooks.registered[a]
                              ? G === n
                                ? ((W = v.getPropertyValue(e, B)),
                                  (G = v.getPropertyValue(e, a, W)))
                          ...
                          if (
                            ...
                            (M = function () {
                              var n,
                                ...
                                s =
                                  o.position === z.lastPosition &&
                                  o.myParent === z.lastParent,
                              ...
                              return (
                                ...
                                u && s
                                  ...
                                  : ((i =
                                    ...
                                    (a.emToPx = z.lastEmToPx =
                                      (parseFloat(
                                        v.getPropertyValue(i, 'paddingLeft'),
                                      ) || 1) / n),
                                    o.myParent.removeChild(i)),
                                null === z.remToPx &&
                                  (z.remToPx =
                                    parseFloat(
                                      v.getPropertyValue(r.body, 'fontSize'),
                                    ) || 16),
                                null === z.vwToPx &&
                  ...
                  !1 !== y.mock &&
                    ...
                    c.progress &&
                      !A.isFunction(c.progress) &&
                      (c.progress = null),
                    c.complete &&
                      !A.isFunction(c.complete) &&
                      (c.complete = null),
                    c.display !== n &&
                      null !== c.display &&
                      ((c.display = ('' + c.display).toLowerCase()),
                      'auto' === c.display &&
                        (c.display = y.CSS.Values.getDisplayType(e))),
                    c.visibility !== n &&
                      null !== c.visibility &&
                    ...
                    !1 === c.queue
                      ? c.delay
                        ? ((l = y.State.delayedElements.count++),
                          ...
                          (o(e).delay = parseFloat(c.delay)),
                          (o(e).delayTimer = {
                            setTimeout: setTimeout(i, parseFloat(c.delay)),
                            next: u,
                          }))
                        : i()
                  ...
                  for (F = b + 1, P = {}, E = F; E < arguments.length; E++)
                    ...
                    (!/^(fast|normal|slow)$/i.test(arguments[E]) &&
                      ...
                      ? A.isString(arguments[E]) || A.isArray(arguments[E])
                        ...
                        : A.isFunction(arguments[E]) &&
                          (P.complete = arguments[E])
                    ...
                    if (!g.isPlainObject(S) || A.isEmptyObject(S))
                      return A.isString(S) && y.Redirects[S]
                        ? ((u = g.extend({}, P)),
                          ...
                          (q = u.delay || 0),
                          !0 === u.backwards &&
                            (w = g.extend(!0, [], w).reverse()),
                          g.each(w, function (e, t) {
                            parseFloat(u.stagger)
                              ? (u.delay = q + parseFloat(u.stagger) * e)
                              : A.isFunction(u.stagger) &&
                                (u.delay = q + u.stagger.call(t, e, V)),
                              u.drag &&
                                ((u.duration =
                                  parseFloat(j) ||
                                  (/^(callout|transition)/.test(S) ? 1e3 : m)),
                                (u.duration = Math.max(
                                  u.duration *
                                    (u.backwards ? 1 - e / V : (e + 1) / V),
                                  0.75 * u.duration,
                                  200,
                                ))),
                              y.Redirects[S].call(
