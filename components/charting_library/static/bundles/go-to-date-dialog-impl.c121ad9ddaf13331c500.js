      ...
      function e(e, t) {
        ...
        (this._drag = null),
          ...
          (this._onTouchDragStart = function (e) {
            document.addEventListener('touchmove', n._onTouchDragMove),
              n._dragStart(i(e));
          }),
          ...
          (this._onTouchDragEnd = function (e) {
            document.removeEventListener('touchmove', n._onTouchDragMove),
              n._onDragStop();
          }),
        ...
        (e.prototype._moveDialog = function (e, t) {
          ...
          (this._dialog.style.left = o(e, n.width, window.innerWidth) + 'px'),
            (this._dialog.style.top =
              o(t, n.height, window.innerHeight) + 'px');
        }),
        e
      );
    })();
          ...
          (t.prototype.render = function () {
            var e,
              ...
              M = i.createElement(
                'input',
                r.__assign(
                  { ref: _, className: E, key: 'textInput', style: y },
                  g,
                ),
              );
            return (
              p &&
                ((e = {
                  className: s(c.leftComponent, p.props.className),
                  key: 'leftComponent',
                }),
              ...
              h &&
                ((t = {
                  className: s(c.rightComponent, h.props.className),
                  key: 'rightComponent',
                }),
        ...
        return (
          ...
          (t.prototype.render = function () {
            var e,
              ...
              n = c(
                p.inputIcon,
                ((e = {}), (e[p.disabled] = this.props.disabled), e),
              );
            return r.createElement(
              'div',
                ...
                r.createElement(
                  'span',
                  {
                    className: c(
                      i.number,
                      ((e = {}),
                      (e[i.active] = this.state.faceType === h.Hours),
                      e),
                    ),
                ...
                r.createElement(
                  'span',
                  {
                    className: c(
                      i.number,
                      ((t = {}),
                      (t[i.active] = this.state.faceType === h.Minutes),
                      t),
                    ),
              ...
              r.createElement(
                ...
                r.createElement(
                  ...
                  r.createElement(
                    ...
                    this.state.faceType === h.Hours
                      ? this._renderHours()
                      : null,
                    this.state.faceType === h.Minutes
                      ? this._renderMinutes()
                      : null,
                  ),
