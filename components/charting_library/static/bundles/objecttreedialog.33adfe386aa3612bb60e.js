      ...
      o(1300),
        ...
        (i.prototype.getSourceProperties = function () {
          ...
          for (t = 0; t < this._model.panes().length; t++) {
            for (
              e = this._model.panes()[t], o = [], i = e.orderedSources(), r = 0;
              r < i.length;
              r++
            )
              (s = i[r]),
                s.showInObjectTree() &&
                  o.push({ datasource: s, name: s.title() });
      ...
      (i.prototype._renderViewInternal = function (t) {
        ...
        for (
          ...
          (i = this._filter.applyToGroup(e[o].children)),
            i.length &&
              ((r = $('<div class="tv-objects-tree-tab__group">').appendTo(
                this._$contentWrapper,
              )),
      ...
      o(1290),
        ...
        (r.prototype.createTreeNodeItem = function (t, e, o) {
          ...
          return (
            ...
            r.click(
              function (e) {
                e.preventDefault(),
                  this._nodeRemoveCallback && this._nodeRemoveCallback(s, t);
              }.bind(this),
            ),
            s
          );
        ...
        (r.prototype.createItem = function (t, e) {
          ...
          return (
            ...
            o.userEditEnabled() &&
              (e.lockUnlock &&
                this._setupLockUnlockButton(s.find('.js-lock-unlock-btn'), o),
              e.showHide &&
        ...
        (r.prototype.updateNodeItem = function (t, e, o, i) {
          ...
          r.toggleClass('i-bold', i.isCurrent),
        ...
        (r.prototype._setDataSourceIcon = function (t, e) {
          ...
          i.removeClass('i-text-icon i-empty'),
            ...
            null === o
              ? i.addClass('i-empty')
              : 'svg' === o.type
              ? $(o.svgCode).attr({ width: 20, height: 20 }).appendTo(i)
              : 'text' === o.type &&
                (i.addClass('i-text-icon'), i.text(o.text)),
            t.prepend(i);
        }),
